...
int main(int argc, char** argv){
  ...
  ac.sendGoal(goal);
  outputFile << "Time,PosError,Criteria1,,Criteria2,,Criteria3,,Criteria4,,Criteria5,,Criteria6"<<endl;
	...
	//cout << elapsed<<","<<pos_error<<",";
  	...
  	if (rss_g_ready&&rss_r_ready&&pose_ready){
		...
		//double array[1]={-80}; 
  		...
  		cout << rms_all<<","; //for rms system
  		outputFile << rms_all << ","; //for rms system
  		if(rms_all > i/(-10)){ //goal criteria
  			//not goal
  			cout<< "0,";
  			outputFile << "0,";
  		}
